...
```{r echo=FALSE}
census_api_key("a08a68ac1c28962a796c651e815d67c03fa36d1f", install=TRUE)
...
Is the difference between Calvert and Montgomery significant? **No, because the bars overlap**

Is the difference between Howard and everyone else significant? **Yes - no bars overlap with them**
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **Are zipcodes the most efficient way to separate this data set?**
