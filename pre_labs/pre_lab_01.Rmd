...
**Task** In the console (look below), type 2+2 and hit enter. What does it return? Type your answer below. [1] 4
...
The last name column and amount column data types are characters and double class values. They represent the last name of people and the amount of money they donated. 
...
I think the code is counting the number of contributions on specific dates. 
...
The contributions are now ordered from highest to lowest in the specific section of dates, and the result shows a different dataset. 
...
It's grouped by the organization and the amount, instead of by the date, giving you just who gets the highest donations. 
...
It now has nothing to do with amount - just a list of who's recieving the contributions.  
...
The way they are arranged has been changed, changing the result to the organizations receiving the most contributions. Some of the top results are the Trump National Committee and the Trump Save America Joint Fundraising Committee. 
...
It's now grouped by city, making the data now sorted by cities. The result now shows cities and different ways to see contribution numbers. 
