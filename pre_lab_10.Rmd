...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Precinct_ID, Precinct_Name, Congress, Legis, Council, School, Polling_ID, Shame_Length, Shape_Area, and Shape**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Data of different voting precincts**
...
**Task** Run the following code. Describe the output in the space below. **A map of PG county**
...
**Task** Run the following code. Describe the output in the space below. **Installation of packages**
...
**Task** Run the following code. Describe the output in the space below. **Large dataset with lots of different columns**
...
**Task** Run the following code. Describe the output in the space below. **Error statement**
