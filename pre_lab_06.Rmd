...
**Task** Export the CSV file to your pre_lab_06 folder and read it into R by running the following codeblock. What problems do you see with the data? **A few blank columns resulting in NAs. **
...
**Task** Get rid of rows we don't need by running the codeblock below. What problems remain? **Columns we don't need - specifically, X29 and X31, as well as some issues with column names. **
...
**Task** Run the codeblock below. What changed, and what issues or problems remain? **There's now a party column and multiple headers of columns had their names changed, X29 and X31 are still just NAs. **
