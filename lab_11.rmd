...
boe_results |>
  ...
  mutate(
    ...
    mail_in_ballot = as.numeric(str_remove(mail_in_ballot, ",")), 
    provisional = as.numeric(str_remove(provisional, ",")), 
...
**A2** It refers to the election for Governor. 
...
**A3** You could see how Cardin values different issues, and if his stance on them changes over time. It would be useful to have cardin's votes on issues, so we could see if they go along with what he's saying in the press releases. 
