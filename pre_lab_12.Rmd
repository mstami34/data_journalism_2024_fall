...
**Task** Run the following code and describe the results. Is it more interesting than before? **I think so - it shows what issues are prioritized. **
...
**Task** Run the following code and describe the results. **In both years, there are shared words that occur in many instances, like baltimore, health, and others**
...
**Task** Run the following code and describe the results. **Most used phrases, with phrases being defined as two words - these occur less than the singular words**
...
**Task** Run the following code and describe the results. **Similar to the 2022 phrases - just a different order. Seems like most of these topics remained as important issues. **
