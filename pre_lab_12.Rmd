...
**Task** Run the following code and describe the dataframe it outputs. **Dates, Titles, Links, URL, and Texts for various online press releases**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **The unique function takes instances from a words list and seperates them, taking out repeat values**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Every unique word in the release is isolated. **
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **I think so - a lot of "the"**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Yes, it's sorted by the amount and percent of the words**
...
**Task** Run the following code and describe the results. **The top ten words in each year, sorted in order of percentage**
...
**Task** Run the following code and describe the results. **Two word phrases, sorted by occurence and percentage**
...
**Task** Run the following code and describe the results.**same thing as last, two word phrases sorted by occurence and percentage**
...
**Task** Run the following code and describe the differences between the two results. Which one might be more useful for the press release data? **The first one has more variation, so probably that one**
...
**Task** Run the following code and describe the differences between the two results. Which one is more useful? **The first one, because it covers a broader base of the same terms**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **They seem accurate to me**
