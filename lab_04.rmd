...
**A1.**
The largest amount of spending in the Alsobrooks Campaign is Media Advertising, which is approaching 6 Million, while the 
```{r}
md_new_senate_expenses <- read_csv("data/md_new_senate_expenses.csv")
