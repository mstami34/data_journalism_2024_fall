...
**The first step is creating a dataset - unaf_diff - by comparing 2024 and 2022. The next step arrenges in descending order and selects the top ten counties. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **A blank page. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. **A bar graph with different counts and counties**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The counties are ordered by count instead of alphabetically**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The graph is flipped to the side**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **The theme has changed to minimal - the visual appearance is different**
...
**Task** Run the following code. **Ran**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **The colors and theme in the background are different**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **There's now a title, different labeling on the sides, and a caption with a source. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. **A table with the date and total contributions in order of date**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Line graph showing changes in total contributions over time**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **The same chart as earlier, except now with markpoints one week apart instead of each month. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. **The angle of the x axis text changed. **
