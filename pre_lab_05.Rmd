...
**Task** Load the five CSV files. Do they have the same column structure? Yes, they all have the same 25 by 8 row/column structure. 
...
**Task** Load the Maryland 2020 county population data **Answer** Data loaded
...
**Task** Run the following code to join Maryland population data and the 2020 voter registration data together using the common column county as the key. How many rows are there now? How many *should* there be? **24 rows, but there should be 25**
...
**Task** Create a new dataframe with population and voter data joined together. What does the output message below say about the join? it says the join is joining with the join_by(COUNTY), meaning those are the columns it uses for the join. 
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Prince George's County by a solid margin**
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **The percent 18 plus numbers are much lower, but the dems vary like the other one**
...
**Task** Run the following code to load the Zip Code Tabulation Area data for Maryland. What's the datatype of the ZCTA5N? column? **double precision**
...
**Task** Run the following code to change the datatype of ZCTA5N from numeric to character. What's the datatype of ZCTA5N now? **character**
